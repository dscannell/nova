...
authorize = extensions.extension_authorizer('compute', 'create-live-image')
...
class Create_live_image(extensions.ExtensionDescriptor):
    """Extension to live-snapshot an instance.
    ...
    updated = "2013-06-21T00:00:00+00:00"
